...
$_ARCHITECT_INSTALLATION_DATA_DATABASE_CONNECT_INITIALIZE->query("CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_INSTALL_DATABASE_SERVER_DATABASE_TABLES_CONNECT_NAME_DATABASE_TABLE_PREFIX\"_messenger_p2p_clear_text_room (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
messenger_room_creation_author VARCHAR(100),
messenger_room_creation_internet_protocol_address VARCHAR(100),
messenger_room_creation_timestamp VARCHAR(100),
messenger_room_file_size VARCHAR(10),
