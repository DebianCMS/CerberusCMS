...
if ($DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials_Member_Status_Account_Active >= "1") {
	...
	header("Location: ?$_INTERNAL_APPLICATION_MODULE_MEMBER=Login&Authorization=AccountActive&$_GLOBAL_SYSTEM_SECURITY_CACHE_CIRCUMVENTION_HTR_RANDOM_STRING_GENERATION");
	exit;
