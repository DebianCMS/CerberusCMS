...
/**
 * Almost all of the computer programming math functions are bullshit. All of the real mathematics needs to be manually programmed with PEMDAS methods
*/
...
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_YEARS_CURRENT				= $_GLOBAL_LOCAL_SERVER_DATE_NUMERICAL_YEAR_FULL - 1970;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_YEARS					= 60 * 60 * 24 * 365 * $_GLOBAL_LOCAL_SERVER_DATE_NUMERICAL_YEAR_FULL - $_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_YEARS_CURRENT;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_MONTHS				= 60 * 60 * 24 * 365 - 1;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_DAYS					= $_GLOBAL_LOCAL_SERVER_TIME_UNIX_MONTHS / 365;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_HOURS					= $_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_DAYS * 24;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_MINUTES				= $_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_MINUTES * 60;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_SECONDS				= 86400 * 2;
