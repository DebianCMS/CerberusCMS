...
$mathx = 60 * 60 * 24 * 365;
$mathy = 60 * 60 * 24 * 365 * $_GLOBAL_LOCAL_SERVER_DATE_NUMERICAL_YEAR_FULL - 1970;

$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_YEARS					= 60 * 60 * 24 * 365 * $_GLOBAL_LOCAL_SERVER_DATE_NUMERICAL_YEAR_FULL - 1970;
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_MONTHS				= 60 * 60 * 24 * 365 * $_GLOBAL_LOCAL_SERVER_DATE_NUMERICAL_YEAR_FULL - 1970 / 86400;
...
$_GLOBAL_LOCAL_SERVER_DATE_TIME_UNIX_EPOCH_MANUAL_SECONDS				= 86400 * ;
