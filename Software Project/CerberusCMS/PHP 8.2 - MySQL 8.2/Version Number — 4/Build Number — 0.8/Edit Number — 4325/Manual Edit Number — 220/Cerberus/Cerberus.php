...
$_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT 					= mysqli_connect($_ACCESS_DATABASE_SERVER_HOSTNAME, $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD, $_ACCESS_DATABASE_SERVER_DATABASE_NAME, $_ACCESS_DATABASE_SERVER_HOSTNAME_PORT);
$_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_DATABASE_NAME_SELECT 				= mysqli_select_db($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, $_ACCESS_DATABASE_SERVER_DATABASE_NAME);
...
// Mathematics need to be perfected
...
$_DB_Query_Kernel_Security_Update_Member_Account_Force_Logout			= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_security_setting_flag_force_logout='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
$_DB_Query_Kernel_Security_Check_Cookie_Member_UserName_AND_Password 					= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_password='$_GLOBAL_COOKIE_MEMBER_PASSWORD'");
...
if (mysqli_num_rows($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, $_DB_Query_Kernel_Security_Check_Cookie_Member_UserName_AND_Password)) {
/**
 * Do Nothing
**/
} else {
...
if (mysqli_num_rows($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, $_DB_Query_Kernel_Security_Check_Cookie_Member_Electronic_Mail_Address)) {
/**
 * Do Nothing
**/
} else {
...
$_DB_Query_Kernel_Update_Member_Rank 							= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_level_rank='$_Kernel_Member_Rank_Level_Update_Digit' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME'");
...
$DB_Query_Kernel_Authenticate_Check_Member_Account_Entry					= mysqli_num_rows($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, $DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials);
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Remote	= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_authentication_server_remote='$_GLOBAL_REMOTE_SERVER_ADDRESS' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Local	= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_authentication_server_local='$_GLOBAL_LOCAL_SERVER_ADDRESS' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Device	= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_authentication_server_device='$_GLOBAL_REMOTE_SERVER_ADDRESS' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_Active					= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_status_account_active='1' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_Digital_Fingerprints				= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_security_fingerprint_cleartext='$_INTERNAL_SECURITY_GENERATED_MEMBER_FINGERPRINT_AUTHENTICATION_CLEARTEXT',member_security_fingerprint_hashed='$_INTERNAL_SECURITY_GENERATED_MEMBER_FINGERPRINT_AUTHENTICATION_HASHED' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
...
$DB_Query_Kernel_Member_Account_Update_Attempt_Authentication					= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_attempt_authentication='$_Kernel_Check_Member_Account_Credentials_Increment_Member_Attempt_Authentication' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
...
$_DB_Query_Kernel_Logout_Remove_Member_Account_Authorized_IP_Address				= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_authorized='000.000.000.000',member_ip_address_authorized_multifactor='000.000.000.000' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
$_DB_Query_Kernel_Logout_Remove_Member_Account_Status_Active					= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_status_account_active='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
$_DB_Query_Kernel_Logout_Remove_Member_Account_IP_Authorization_Token				= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_authorization_token='0' WHERE member_username='$_GLOBAL_COOKIE_MEMBER_USERNAME' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
...
$_DB_Query_Kernel_Application_Panels_Aligned_Left 					= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels WHERE panel_alignment='0' AND panel_file_status='1' ORDER BY panel_row ASC");
...
$_DB_Query_Kernel_Select_Applications_Services							= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_services ORDER BY id ASC");
...
$_DB_Query_Kernel_Select_Applications_Root							= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_root ORDER BY id ASC");
...
$_DB_Query_Kernel_Select_Applications_Administration 						= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_administration ORDER BY id ASC");
...
$_DB_Query_Kernel_Select_Applications_Member 							= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications ORDER BY id ASC");
...
$_DB_Query_Kernel_Select_Custom_Applications 						= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications_custom ORDER BY id ASC");
...
$_DB_Query_Kernel_Application_Panels_Aligned_Right 					= mysqli_query($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT, "SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels WHERE panel_alignment='1' AND panel_file_status='1' ORDER BY panel_row ASC");
...
if (mysqli_close($_KERNEL_MYSQL_IMPROVED_DATABASE_SERVER_CONNECT)) {
