...
$_GLOBAL_SQL_DATABASE_SERVER_CONNECTION					= mysqli_connect($_ACCESS_DATABASE_SERVER_HOSTNAME, $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD, $_ACCESS_DATABASE_SERVER_DATABASE_NAME);
...
class DB {
	...
	function connect($_Global_SQL_Server_Statement_Connect) {
		...
		$_Global_SQL_Server_Statement_Connect			= mysqli_connect($_ACCESS_DATABASE_SERVER_HOSTNAME, $_ACCESS_DATABASE_SERVER_USERNAME, $_ACCESS_DATABASE_SERVER_PASSWORD, $_ACCESS_DATABASE_SERVER_DATABASE_NAME) or die(mysqli_error());
